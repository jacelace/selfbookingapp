...
import { initializeTestUsers } from '../firebase/initializeUsers';
    ...
    const initialize = async () => {
      try {
        ...
        if (app) {
          ...
          setInitializationStep('Initializing Firestore...');
          
          // Initialize Firestore with default data
          const firestoreResult = await initializeFirestore();
          if (!firestoreResult.success) {
            throw new Error(firestoreResult.message);
          }
          
          setInitializationStep('Creating test users...');
          // Initialize test users
          const usersResult = await initializeTestUsers();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">{initializationStep}</p>
        </div>
      </div>
    );
  }
